...
PYTHONPATH="$PWD:$PWD/src" WANDB_MODE=disabled python src/eval_cross_year.py \
  ...
  --checkpoint_json "/share/home/e2406754/cde_mt/WildfireSpreadTSPlus/inputs/3_utae_cross_year_spatial_ecol2l3_pos_weight.json" \
  --train_years "2018" \
  --test_years "2016,2017,2018,2019,2020,2021,2022,2023" \
  --output_csv "/share/home/e2406754/cde_mt/WildfireSpreadTSPlus/results/3_utae_cross_year_evaluation_ecol2l3_pos10.csv" \
  --disable_wandb
